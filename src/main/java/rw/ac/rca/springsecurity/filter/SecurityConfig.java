package rw.ac.rca.springsecurity.filter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth.requestMatchers("/users/welcome", "/users/addNewUser", "/users/generateToken", "/users/**","/academics/**", "/laptops/**", "/swagger-ui/**", "/api-docs").permitAll())
